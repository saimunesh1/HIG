...
public enum CollectionFlowLayoutSpacingMode {
...
class OnboardingFlowLayout: UICollectionViewFlowLayout {
	...
	private var originalItemSize: CGSize!
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
		if originalItemSize == nil {
			originalItemSize = self.itemSize
		} else {
			self.itemSize = originalItemSize
		}
